...
namespace Gravitas.Core.Manager.VkModuleSocket2
{
    ...
    public class VkModule2In2OutStateXml : VkModuleSocket1.VkModuleRelayStateXml
    {
        [XmlIgnore] public bool Out0 { get; set; }
        [XmlIgnore] public bool Out1 { get; set; }

        [XmlIgnore] public bool In0 { get; set; }
        [XmlIgnore] public bool In1 { get; set; }
