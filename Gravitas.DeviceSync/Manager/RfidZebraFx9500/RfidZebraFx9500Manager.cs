...
{
    internal class RfidZebraFx9500Manager : IRfidZebraFx9500Manager
    {
...
//			// Clear old tags
//			foreach(RfidZebraFx9500AntennaInJsonState antennaState in headState.InData.AntenaState.Select(t => t.Value)) {
//				foreach(var tag in antennaState.TagList.ToList()) {
//					if (Math.Abs((tag.Value - DateTime.Now).TotalSeconds) > 30)
//						antennaState.TagList.Remove(tag.Key);
//				}
//			}
