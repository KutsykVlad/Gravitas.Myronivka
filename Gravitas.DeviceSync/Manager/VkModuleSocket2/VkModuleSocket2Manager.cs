...
namespace Gravitas.DeviceSync.Manager.VkModuleSocket2
{
    internal class VkModuleSocket2Manager : IVkModuleSocket2Manager
    {
        ...
        {
            var state = new VkModule2In2OutStateXml();
